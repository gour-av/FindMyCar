...
public class WoodenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wooden, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        find_car = view.findViewById(R.id.img_wooden_find_car);
        ...
        Save_Car = view.findViewById(R.id.img_wooden_save);
